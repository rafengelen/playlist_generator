...
public class SongService {
    ...
    public void loadData() {
        if(songRepository.count() == 0){
            ...
            song1.setCode("faeafefeafeafeafefefaaef");
            ...
            song2.setCode("aegaeeagaehaehaeeaeaheah");
            ...
            song3.setCode("eagaeiophaehjaemhaejmlhea");
            ...
            song4.setCode("feeagahnpanhpaenphnaepnheapnhepapaenpeanpheanpo");
